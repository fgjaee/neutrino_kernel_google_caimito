...
static void dsim_of_get_pll_diags(struct dsim_device *dsim __maybe_unused)
{
}
...
static int dsim_encoder_late_register(struct drm_encoder *encoder __maybe_unused)
{
        return 0;
}

static void dsim_encoder_early_unregister(struct drm_encoder *encoder __maybe_unused)
{
}
